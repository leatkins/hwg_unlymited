...
<main id="main">
            ...
            <div class="container-lg">
                ...
                if (!empty($_SESSION['lineItems'])) {
                    ...
                    echo '<div class="container-sm" style="padding-top:100px;padding-left:75%;text-align:right">
                                    ...
                                    <input type="hidden" id="payPalGrandTotal" value="' . number_format($grandTotal, 2) . '"/>
                             </div>';
                }
                ?>
    ...
    <section id="customerForm" style="background-color:whitesmoke">
        <div class="container-sm">
            <form class="form-control-lg" action="thankYou.php" method="POST">


                <div class="text-center" style="margin-top:25px">

                    <textarea rows="3" cols="25" name="orderObject" id="orderObject" style="display:none"></textarea>
                        ...
                        paypal.Buttons({
                            ...
                            onApprove: function (data, actions) {
                                return actions.order.capture().then(function (orderData) {
                                    ...
                                    document.getElementById('orderObject').innerHTML = JSON.stringify(orderData);
                                    console.log('Capture result', orderData, JSON.stringify(orderData, null, 2));
                                    // var transaction = orderData.purchase_units[0].payments.captures[0];
                                    // alert('Purchase Complete \n\n Transaction Details: ' + transaction.status + ': ' + transaction.id );
...
<!--                    <button class="btn btn-success btn-lg" type="hidden" id="submitOrder" name="submitOrder">-->
<!--                        <bi class="bi-check-circle-fill"></bi>&nbsp; COMPLETE ORDER-->
<!--                    </button>-->
                    <button type="submit" name="submitOrder" id="submitOrder" style="display:none">Submit</button>
