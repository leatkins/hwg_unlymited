    ...
    <div class="container d-flex align-items-center justify-content-between">
        ...
        <nav id="navbar" class="navbar">
            <ul>
                ...
                <li class="dropdown"><a href="index.php#products"><span>Products</span> <i
                    ...
                    <ul>
                        ...
                        <li><a href="#">Body Gels</a></li>
                        <li><a href="#">Sprays</a></li>
                        <li><a href="#">Burning Oils</a></li>
...
<main id="main">
        ...
        <div class="container-fluid">
            <div class="container-lg">
                ...
                if (!empty($_SESSION['lineItems'])) {
                    ...
                    $grandTotal = $handlingFee + $subTotal;
    ...
    <section id="customerForm" style="background-color:whitesmoke">
        <div class="container-sm">
            <form class="form-control-lg" action="checkOutScript.php" method="POST">
                <div class="input-group-lg">
                    <h1>Customer Information</h1>
                    <hr>


                        <strong>First Name: &nbsp; </strong><input style="width:50%" type="text" name="firstName" id="firstName" required /><br /><br />
                        <strong>Last Name: &nbsp; </strong><input type="text" style="width:50%" name="lastName" required /> &nbsp; <br /><br />
                        <strong>E-Mail Address: &nbsp; </strong><input style="width:50%" type="email" name="emailAddress" placeholder="email@domain.com" required /><br /><br />
                        <strong>Phone Number: &nbsp;</strong><input style="width:50%" type="text" name="phoneNumber" placeholder="123-456-7890" />
                        <br /><br />
                        <h5>SHIPPING ADDRESS </h5>
                        <hr />
                        <strong>Address: &nbsp; </strong><input style="width:50%" type="text" id="shipAddress" name="shipAddress" placeholder="Address Line 1" required />
                    <br /><br /><strong>Line 2: &nbsp;</strong><input style="width:50%" type="text" id="shipAddress2" name="shipAddress2" placeholder="Address Line 2" />
                    <br /><br /><strong>City: &nbsp; </strong><input type="text" id="shipCity" name="shipCity" required />&nbsp;
                    <strong>State: &nbsp; </strong><input type="text" id="shipState" name="shipState" required /> &nbsp;
                    <strong>Zip Code: &nbsp; </strong><input type="text" id="shipZipCode" name="shipZipCode" required /> <br /><br />

                    <h5>BILLING ADDRESS </h5>
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" role="switch" name="matchShippingAddress" onclick="duplicateAddress()" id="matchShippingAddress">
                        <label class="form-check-label" for="matchShippingAddress">Match Shipping Address</label>
                    </div>
                    <hr />
                    <strong>Address: &nbsp; </strong><input style="width:50%" type="text" id="billAddress" name="billAddress" placeholder="Address Line 1" required />
                    <br /><br /><strong>Line 2: &nbsp;</strong><input style="width:50%" type="text" id="billAddress2" name="billAddress2" placeholder="Address Line 2" />
                    <br /><br /><strong>City: &nbsp; </strong><input type="text" id="billCity" name="billCity" required />&nbsp;
                    <strong>State: &nbsp; </strong><input type="text" id="billState" name="billState" required /> &nbsp;
                    <strong>Zip Code: &nbsp; </strong><input type="text" id="billZipCode" name="billZipCode" required />
                </div>
                        ...
                        paypal.Buttons({
                            ...
                            onApprove: function(data, actions) {
                                return actions.order.capture().then(function(orderData) {
                                    ...
                                    document.getElementById('firstName').value = JSON.stringify(orderData.payer.name);
                ...
                <div class="text-center" style="padding-top:50px">
                    <button class="btn btn-success btn-lg" type="submit"><bi class="bi-check-circle-fill"></bi>&nbsp; COMPLETE ORDER</button>
                </div>
